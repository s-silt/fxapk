        ...
        "leads": [
            {
                ...
                "is_c2": True,
                "source_refs": [
                    {"source": "dex", "location": "com/x/Api.java", "snippet": "...", "scope": "case_evidence"},
                    {"source": "manifest", "location": "AndroidManifest.xml", "scope": "case_evidence"},
                ],
            },
            {
                ...
                "confidence": "MEDIUM",
                "is_c2": False,
                "source_refs": [{"source": "resource", "location": "strings.xml", "scope": "case_evidence"}],
            },
            {
