...
def test_snapshot_pickle_roundtrip_excludes_worker_apk() -> None:
    ...
    snap = SnapshotContext(
        ...
        config=None, apk_path="", extra_dex_paths=[], jadx_cache_root=None, jadx_baseline_index=None, permissions=["p"], components=None,
...
def test_snapshot_read_file_missing_no_apk_returns_none() -> None:
    ...
    snap = SnapshotContext(
        ...
        apk_path="", extra_dex_paths=[], jadx_cache_root=None, jadx_baseline_index=None, permissions=[], components=None,
...
def _snap_with_declared(declared: dict[str, int]) -> SnapshotContext:
    snap = SnapshotContext(
        package_name="", manifest_xml="", platform="android", config=None,
        apk_path="/x.apk", extra_dex_paths=[], jadx_cache_root=None, jadx_baseline_index=None, permissions=[], components=None,
        dex_strings=(), file_list=[], native_libs=[], certificates=[], files={},
    )
...
def test_ensure_declared_sizes_reads_real_zip(tmp_path: object) -> None:
    ...
    snap = SnapshotContext(
        package_name="", manifest_xml="", platform="android", config=None,
        apk_path=str(apk), extra_dex_paths=[], jadx_cache_root=None, jadx_baseline_index=None, permissions=[], components=None,
        dex_strings=(), file_list=[], native_libs=[], certificates=[], files={},
    )
...
def test_snapshot_carries_jadx_cache_root_through_pickle() -> None:
    ...
    snap = SnapshotContext(
        package_name="", manifest_xml="", platform="android", config=None,
        apk_path="", extra_dex_paths=[], jadx_cache_root="D:/idx-cache", jadx_baseline_index=None,
