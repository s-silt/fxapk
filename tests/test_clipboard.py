...
from apkscan.core.models import Confidence, Evidence, EvidenceScope, Lead, LeadCategory, Report
...
def test_merge_clipboard_batch_runtime_ref_does_not_block_case_evidence(
    ...
    lead = Lead(
        ...
        source_refs=[
            Evidence(
                ...
                snippet=f"运行时剪贴板抓取链上地址（TRON）：{_TRON_ADDR}"[:200],
    ...
    assert {evidence.scope for evidence in lead.source_refs} == {
