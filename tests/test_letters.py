...
def _payment_lead() -> dict:
    ...
    return {
        ...
        "source_refs": [
            ...
            {
                "source": "dex",
                "location": "com/x/Pay.java",
                "evidence_id": "ev-pay-0002",
                "scope": "case_evidence",
            },
        ],
    }
...
def _certificate_signing_lead() -> dict:
    ...
    return {
        ...
        "confidence": "HIGH",
        "source_refs": [
            {"source": "cert", "location": "CN=Android Debug", "scope": "case_evidence"}
        ],
    }
...
def _crypto_recipe_lead() -> dict:
    ...
    return {
        ...
        "confidence": "HIGH",
        "source_refs": [
            {"source": "dex", "location": "bundle.js", "scope": "case_evidence"}
        ],
    }
...
def _not_investigate_lead() -> dict:
    ...
    return {
        ...
        "confidence": "LOW",
        "source_refs": [
            {"source": "dex", "location": "x.java", "scope": "case_evidence"}
        ],
    }
...
def test_letter_body_contains_case_close_resolved_evidence() -> None:
    ...
    ip = "198.51.100.41"
    evidence = Evidence(source="dex", location="classes.dex")
    endpoint = Endpoint(
        ...
        "leads": [
            {
                ...
                "advice": "建议调证",
                "source_refs": [
                    {"source": "dex", "location": "a.java", "scope": "case_evidence"}
                ],
            }
        ]
    }
...
def _lead_for(value: str) -> dict:
    ...
    return {
        ...
        "source_refs": [{"evidence_id": "E1", "scope": "case_evidence"}],
    }
