...
def test_classify_ip_real_backends_still_investigate():
    ...
    """
    for value in (
        "103.36.167.109:443/tcp",  # leak-scan: allow classify_ip 分档夹具，非 is_global 会直接落 ADVICE_SKIP、advice 断言失去意义
        "134.175.85.26:30147/tcp",  # leak-scan: allow classify_ip 分档夹具，非 is_global 会直接落 ADVICE_SKIP、advice 断言失去意义
        "154.206.232.17",  # leak-scan: allow classify_ip 分档夹具，非 is_global 会直接落 ADVICE_SKIP、advice 断言失去意义
        "45.202.1.163",  # leak-scan: allow classify_ip 分档夹具，非 is_global 会直接落 ADVICE_SKIP、advice 断言失去意义
        "65.75.210.121",  # leak-scan: allow classify_ip 分档夹具，非 is_global 会直接落 ADVICE_SKIP、advice 断言失去意义
        "15.204.18.128",  # leak-scan: allow classify_ip 分档夹具，非 is_global 会直接落 ADVICE_SKIP、advice 断言失去意义
        "222.167.33.27",  # leak-scan: allow classify_ip 分档夹具，非 is_global 会直接落 ADVICE_SKIP、advice 断言失去意义
        "8.210.13.45",  # leak-scan: allow classify_ip 分档夹具，非 is_global 会直接落 ADVICE_SKIP、advice 断言失去意义
    ):
...
def test_is_low_octet_ipv4_shape_only():
    ...
    assert infra.is_low_octet_ipv4("103.36.167.109") is False  # leak-scan: allow classify_ip 分档夹具，非 is_global 会直接落 ADVICE_SKIP、advice 断言失去意义
