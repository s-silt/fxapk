...
// 1) 仅限【有合法授权】的授权分析场景，针对已授权目标 app 的配置端点；非授权目标禁止运行本脚本。
// 2) 枚举=主动外联，会在对方服务器留日志、可能触发风控/打草惊蛇。务必先评估是否惊动目标方；
//    【优先用已掌握的真实企业号】，盲爆字典是下策且可能徒劳(无效号不下发)。
...
// 企业号清单：!!! 优先填【已掌握的真实企业号】(关联个人输入过的) !!! 字典枚举为下策。
var TENANT_LIST = [
