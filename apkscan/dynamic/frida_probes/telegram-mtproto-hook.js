...
// 适用：目标样本大量 Telegram/XIN 二开改包(包名整体替换，如 im.example.repacked1.* / im.example.repacked2.messenger 等占位示例)；普通抓包 endpoint=0(MTProto 自建协议、HTTP 代理看不见)
...
Java.perform(function () {
  ...
  // 原版 org.telegram.* ；二开常整体换包名(占位示例 im.example.repacked1.* / im.example.repacked2.messenger.* 等)，故只匹配类"短名/子串"
